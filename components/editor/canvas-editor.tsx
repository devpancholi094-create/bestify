...
interface CanvasEditorProps {
  ...
  onRequestUpload: (elementId: string) => void;
}

export function CanvasEditor({ stageWrapperRef, onStageReady, onRequestUpload }: CanvasEditorProps) {
          ...
          <ElementNode
            ...
            onSelect={(e) => {
              ...
              if (isShift) {
                ...
                const isEmptyImage = el.type === "image" && !el.src;
                const isEmptyFrame = el.type === "frame" && !el.imageSrc;
                if (isEmptyImage || isEmptyFrame) {
                  onRequestUpload(el.id);
                }
              }
            }}
